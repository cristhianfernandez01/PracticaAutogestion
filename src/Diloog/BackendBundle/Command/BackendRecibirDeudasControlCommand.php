...
class BackendRecibirDeudasControlCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('diloog:backend:recibirdeudascontrol')
            ->setDescription('Controla la recepcion actualizaciones de Estados de Deuda mensualmente para todos los afiliados')
        ;
    }
